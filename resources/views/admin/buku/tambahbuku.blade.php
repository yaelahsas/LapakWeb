            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Tambah Buku Cetak</strong>
                    </div>
                    <div class="card-body card-block">
                        <form action="{{route('admin.buku.storebuku')}}" method="post" enctype="multipart/form-data"class="form-horizontal">
                            @csrf
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" name="foto_cover" class="form-control"><small class="form-text text-muted">Masukkan foto cover disini</small></div>
                            </div>
